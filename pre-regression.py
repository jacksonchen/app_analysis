...
def generate_words_comments():
  ...
  f = open('health-apps/regression_matrices/words_comments.csv', 'wb')
  f.write(words_comments.to_csv())
  f.close()
  f = open('health-apps/regression_matrices/comments_ratings.csv', 'wb')
  f.write(comments_ratings.to_csv())
  f.close()
  f = open('health-apps/regression_matrices/words_per_comment.csv', 'wb')
